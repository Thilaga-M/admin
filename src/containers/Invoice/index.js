...
import { fetchInvoice,viewInvoice } from '../../actions/invoiceActions';
                      ...
                      return(
                        <tr key={i}>
                            ...
                            { action.indexOf("Edit")!==-1 &&
                              <Link to={`billing/edit-invoice/${val.bill_hid}`}><i className="material-icons dp48 invalid">edit</i></Link>
                            }&nbsp;&nbsp;

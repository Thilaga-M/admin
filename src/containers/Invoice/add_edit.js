...
class AddEdit extends React.Component {
  ...
  onprintnow() {
    ...
    if (serviceData.hasOwnProperty("recurring") && serviceData["recurring"]) {
      printableContent2 += `<tr><td colspan="7" style='color: #000;font-weight: 500;font-size: 14px;border:0px;padding: 5px 5px;'>Standing Charges:-</td></tr>`;
    }
        ...
        <div className="transition-item detail-page">
          <div className="main-content">
            <div className="col s12 portlet-title">
              <div className="caption">INVOICE</div>
            </div>
            ...
            <div id="printableContent">
              ...
              >
                <tbody>
                  <tr>
                    <td style={{ border: "none", verticalAlign: 'middle' }} width="60%" >

            ...
            <div className="portlet">
             <div className="transition-item list-page">
                ...
                <div className="col s12 portlet-title"> 
                    <div className="caption">SERVICE 
                    </div>
                  </div>
                <Filter  filterSearch={this.filterSearch.bind(this)} addbtn={(action.indexOf("New")!==-1)?"settings/general/add-service":""}/>
                              ...
                              <table className="striped">
                                <thead>
                                  <tr>
                                    ...
                                    <th className="leftAlignText">Service Name</th> 
                                    <th>Service Type</th> 
                                    {/*<th>Quantity Type</th> */}
                                    <th>Rate</th> 
                                    <th>Action</th>
                                  ...
                                  data.data && data.data.map((val,i)=>{
                                    ...
                                    return(
                                      <tr key={i}>
                                          ...
                                          <td className="leftAlignText">{val.servicename}</td>
                                          <td>{ (val.servicetype==1)?"One Time":"Recurring"}</td>
                                          { /*<td>{val.quantitytype}</td>  */}
                                          <td>{val.rate}</td> 
                                          <td>  
                                            { action.indexOf("Edit")!==-1 &&
                                              <Link to={`settings/general/edit-service/${val.sm_id}`}><i className="material-icons dp48 invalid">edit</i></Link>
                                            }&nbsp;&nbsp;

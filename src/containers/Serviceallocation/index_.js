...
import { fetchServiceallocation,deleteServiceallocation,officespacelist} from '../../actions/serviceallocationActions';
    ...
    let total=(data)?data.total:0;
       return (
             <div className="transition-item list-page">
                ...
                <Filter  filterSearch={this.filterSearch.bind(this)}  addbtn={(action.indexOf("New")!==-1)?"customers/add-serviceallocation":""}/>
                                      ...
                                      <tr key={i}>
                                          ...
                                          <td>
                                            { action.indexOf("Edit")!==-1 &&
                                              <Link to={`customers/edit-serviceallocation/${val.cust_id}`}><i className="material-icons dp48 invalid">edit</i></Link>
                                            }&nbsp;&nbsp;

    ...
    let action=(role.permission)?role.permission.split(","):[];
       return (
            <div className="transition-item list-page">
                ...
                <Filter  filterSearch={this.filterSearch.bind(this)} addbtn={(action.indexOf("New")!==-1)?"settings/add-servicecategory":""}/>
                      ...
                      return(
                        <tr key={i}>
                            ...
                            { action.indexOf("Edit")!==-1 &&
                              <Link to={`settings/edit-servicecategory/${val.sc_id}`}><i className="material-icons dp48 invalid">edit</i></Link>
                            }&nbsp;&nbsp;

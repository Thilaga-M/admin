                                  ...
                                  <table className="striped ">
                                    ...
                                    <tbody >
                                       ...
                                       this.props.invoiceData.map((val,i)=>{
                                        total_amt=parseInt(total_amt)+parseInt(val.proData);
                                        if(val.gst_applicable)totalcgst_amt=Math.round(parseInt(val.proData)*0.09)+totalcgst_amt;
                                        if(val.gst_applicable)totalsgst_amt=Math.round(parseInt(val.proData)*0.09)+totalsgst_amt;
                                            return(
                                              <tr key={i}>
                                              ...
                                              <td className="center-align">{val.proData}</td>  
                                             </tr>)
                                    })
                                    }
